...
Read `.Codex/skills/add-mc-tool-domain/contracts.json` at the start of this skill. It defines the required files to create/modify, naming conventions, and verification steps that must be followed.
