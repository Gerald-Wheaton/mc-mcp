...
Use the **`maintenance-connection-api-rag` skill** (`.Codex/skills/SKILL.md`) whenever you need to look up endpoint details, schemas, or parameters. The two-stage workflow is:
