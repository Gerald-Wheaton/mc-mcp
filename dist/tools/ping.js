...
export function register(server, client) {
    server.registerTool('mc_ping', {
        description: 'Check connectivity and authentication to the Maintenance Connection API. Returns a success message if the API is reachable and credentials are valid.',
    }, async () => {
        try {
