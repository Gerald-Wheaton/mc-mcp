...
Read `.claude/skills/maintenance-connection-api-rag/contracts.json` at the start of this skill. It defines the required artifacts, preferred workflow order, and response requirements that must be followed.
